...
public class UserController {
	...
	//====================================================================	
	//====================================================================
	//==> 단순 navigation &  단순 Text 를 리턴하는 
	//==> IoC, Bean Container 기 Wiring 해주는 지 확인용.
	@RequestMapping("/testIoC")
	public @ResponseBody String testIoC(Model model){
		
		System.out.println("[ TestIoC  start........]");//<== 디버깅용
		
		//==> Client 에 전달할  Message 생성 
		String message = "testIoC : Container 가 정상적 Wiring 함.";
	
		System.out.println("[ TestIoC  end........]\n");
